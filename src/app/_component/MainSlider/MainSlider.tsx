...
<div className="col-span-2">
        ...
        <Image src='/images/slider-image-1.jpeg' alt="img3" width={1000} height={1000} className="w-full h-48 object-cover"/>
      <Image src='/images/slider-image-2.jpeg' alt="img3" width={1000} height={1000} className="w-full h-48 object-cover"/>
</div>
